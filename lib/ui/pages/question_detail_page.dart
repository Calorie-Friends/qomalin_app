  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: FutureBuilder<Question>(
        future: ref.read(QuestionProviders.questionRepositoryProvider()).find(questionId),
        builder: (BuildContext context, snapshot) {
          ...
          return ListView(
            children: [
              QuestionDetail(question: snapshot.requireData)
            ],
          );
        },
      ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Flexible(child: Text(
                  question.address ?? "[${question.location.latitude}, ${question.location.longitude}]",
                ),)
              ],
            ),
            const Divider(height: 2,),
